...
- Liquidity reconstruction, QuoteDataFetcher decoding/ABI, fee presets, token balance batching, picker grouping/navigation, spacing percentage conversion, and canonical configuration are reused or adapted from EkuboProtocol/interface. Source comments identify the original modules.
