...
Private v0.1.1 release verification: [tagged CI run](https://github.com/EkuboProtocol/freelp/actions/runs/34543104970) passed all application, package, accessibility, Lighthouse, and isolated gateway checks. Its downloaded npm tarball was independently installed offline and served through both bunx and npx. The [separate IPNS rehearsal](https://github.com/EkuboProtocol/freelp/actions/runs/34543343197) successfully used the actual Actions signing secret to sign and resolve the tagged release entirely offline. Automatic public publication jobs were skipped by the privacy gates.
