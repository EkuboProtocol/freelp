...
"$ipfs_bin" --offline dag import release/site.car release/release.car
...
"$ipfs_bin" --timeout=2m routing provide "$site_cid" "$release_cid"
echo "Seeded $release_cid from this CI job. Retain release.car on any node for lasting availability."
